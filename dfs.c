...
int lengthOfLIS(int* nums, int numsSize, int* maxSeq)
{
    ...
    int i=0,j = 0,x = 0,max_len = 0,max_index = 0,indice = 0;
    ...
    while(i < numsSize)
    {
        ...
        // if(indice == 0 && indices_memoisation[1] != 0)
        // {
        //     indice = 1;
        //     puts("00za");
        // }
