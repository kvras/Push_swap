...
int     longest_increasing_subsequence_caller(t_stack *stack_a, t_stack *stack_b, int argc, char **argv);
...
int     cleanupandreturn(int *indices_memoisation, int *max_seq, int max_len, int max_index);
void    calculatelis(int *nums, int nums_size, int *len_memoisation, int *indices_memoisation);
void    findmax(int *len_memoisation, int nums_size, int *max_len, int *max_index);
int     parsing(int argc, char **argv, t_stack *stack_a);
int     initialize(int **len_memoisation, int **indices_memoisation, int nums_size);
